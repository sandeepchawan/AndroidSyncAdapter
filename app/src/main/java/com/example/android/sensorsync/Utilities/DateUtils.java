package com.example.android.sensorsync.Utilities;
...
public class DateUtils {
     ...
     *
     * Normalize, in our usage within SensorSync means to convert a given date in milliseconds to
    ...
    /**
     * In order to ensure consistent inserts into SensorProvider, we check that dates have been
